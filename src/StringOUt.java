...
//	Object[][] arr = { {"lineshang",16, 5, "冷兔line篇上", "又萌又贱的冷兔登录LINE贴图商城，亲们也可以用它们来装扮自己的照片哦~~"},{"linexia",16,6, "冷兔line篇下", "又萌又贱的冷兔登录LINE贴图商城，亲们也可以用它们来装扮自己的照片哦~~"},{"lvxing",16,7, "冷兔旅行篇", "带着冷兔一块去旅行吧，旅行篇贴纸双爪奉上！一定要使用哦~"}};
	Object[][] arr = { {"shengdanpian", 10, 13, "圣诞篇", "一起来过萌萌哒圣诞~"}};
...
//		 System.out.print("[");
		 System.out.print("INSERT INTO `lengtoo_emojipackage` VALUES ('"+o[2]+"', '/img/chartlet/chartlet/packageimg/"+o[0]+".png', '"+ o[3] +"', '"+ o[4] +"', '"+sf.format(date)+"', '1', '"+o[1]+"', '2', '90', '90', '1', '1', '1');");
...
//			 System.out.print("INSERT INTO `lengtoo_chartletillustration` VALUES ('"+id+"', '"+o[2]+"', '/img/chartlet/illustration/"+o[0]+i+".jpg', '冷兔表情', '"+sf.format(date)+"', '640', '320', '1', '0');");
		 ...
		 System.out.println("INSERT INTO `lengtoo_emojirollimg` VALUES ('', '/img/emoji/rollimg/"+o[0]+".jpg', '640', '240', '冷兔表情', '"+ o[4] +"', '1', '10', '2014-11-11 10:54:14', '1', '0');");
//		 System.out.println("],");
